...
int getClosestMed(int rdnum1, int rdnum2, int rdnum3)
{
        ...
        if (abs(retnum - rdnum1) < abs(retnum - rdnum2) && abs(retnum - rdnum1) < abs(retnum - rdnum3))
                return rdnum1;
        else if (abs(retnum - rdnum2) < abs(retnum - rdnum1) && abs(retnum - rdnum2) < abs(retnum - rdnum3))
                return rdnum2;
        else if (abs(retnum - rdnum3) < abs(retnum - rdnum2) && abs(retnum - rdnum3) < abs(retnum - rdnum1))
                return rdnum3;
        else
                return retnum;
}